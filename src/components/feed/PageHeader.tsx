  ...
  return (
    <div className="text-center mb-8">
      <h1 className={`font-bold text-gray-900 mb-2 ${isMobile ? 'text-2xl md:text-3xl' : 'text-3xl font-semibold mb-4'}`}>
        Discover Curated Authenticity
      </h1>
      <p className={`text-gray-600 ${isMobile ? 'text-sm md:text-base' : 'text-sm max-w-2xl mx-auto'}`}>
        {isMobile 
          ? 'Curated collections from verified authentic merchants'
          : 'Explore handpicked authentic products from our exclusive network of verified merchants'
        }
      </p>
